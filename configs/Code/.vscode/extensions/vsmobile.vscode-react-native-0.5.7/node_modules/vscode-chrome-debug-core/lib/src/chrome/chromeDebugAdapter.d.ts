...
export declare type CrdpDomain = keyof Crdp.CrdpClient;
export declare abstract class ChromeDebugAdapter implements IDebugAdapter {
    ...
    protected _domains: Map<"DOM" | "Schema" | "Runtime" | "Debugger" | "Console" | "Profiler" | "HeapProfiler" | "Inspector" | "Memory" | "Performance" | "Page" | "Overlay" | "Emulation" | "Security" | "Audits" | "Network" | "Database" | "IndexedDB" | "CacheStorage" | "DOMStorage" | "ApplicationCache" | "CSS" | "DOMSnapshot" | "IO" | "DOMDebugger" | "Target" | "ServiceWorker" | "Input" | "LayerTree" | "DeviceOrientation" | "Tracing" | "Animation" | "Accessibility" | "Storage" | "Log" | "SystemInfo" | "Tethering" | "Browser", Crdp.Schema.Domain>;
    ...
    private sendLoadedSourceEvent(script);
    ...
    private unverifiedBpResponse(args, requestSeq, message?, bpsSet?);
    private unverifiedBpResponseForBreakpoints(args, requestSeq, breakpoints, defaultMessage?, bpsSet?);
    ...
    private targetBreakpointResponsesToClientBreakpoints(url, responses, requestBps, ids?);

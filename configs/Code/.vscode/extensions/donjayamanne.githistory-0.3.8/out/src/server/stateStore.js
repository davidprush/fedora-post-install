...
let StateStore = class StateStore {
    ...
    initialize(id, workspaceFolder, branch, branchSelection, searchText, file) {
        return __awaiter(this, void 0, void 0, function* () {
            this.storesPerWorkspace.set(id, { branch, branchSelection, workspaceFolder, searchText, file });
        });
    }
    updateEntries(id, entries, pageIndex, pageSize, branch, searchText, file, branchSelection) {
        return __awaiter(this, void 0, void 0, function* () {
